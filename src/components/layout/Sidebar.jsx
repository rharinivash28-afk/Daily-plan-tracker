      ...
      <div className="mt-2 flex flex-col gap-0.5">
        ...
        {categoryList.map((cat) => (
          <button
            ...
            className={`flex items-center gap-2.5 px-3 py-1.5 rounded-lg text-sm transition-colors ${categoryFilter === cat.key ? "text-purple-600 dark:text-purple-100 font-medium" : "text-ink-muted hover:bg-black/5 dark:hover:bg-white/10"}`}
          >
